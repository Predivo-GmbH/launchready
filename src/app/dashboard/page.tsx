  ...
  return (
    <div className="py-6 sm:py-12 px-4">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        {!limits.monitoring && (
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 sm:p-6 flex flex-col sm:flex-row items-center gap-4">
            <div className="flex-1 min-w-0">
              <h2 className="text-sm font-semibold text-white mb-1">Automated Monitoring</h2>
              <p className="text-sm text-zinc-400">Track up to 5 sites with weekly re-audits and score change alerts.</p>
            </div>
            <Link href="/pricing" className="text-sm px-4 py-2 min-h-[44px] inline-flex items-center bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition-colors font-medium shrink-0">
              Upgrade to Pro
            </Link>
          </div>
        )}
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/" className="text-sm px-4 py-2 min-h-[44px] inline-flex items-center bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition-colors font-medium">New Audit</Link>
          </div>

          {manualAudits.length === 0 ? (
            <div className="text-center py-16 space-y-4">
              <p className="text-zinc-400">No audits yet. Run your first audit!</p>
              <Link href="/" className="inline-flex items-center min-h-[44px] px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-lg transition-colors">Run Audit</Link>
            </div>
          ) : (
